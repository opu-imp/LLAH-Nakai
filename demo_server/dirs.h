...
#define	CONST_MULTI_HASH_MODE	(11)	/* Construct multiple hash tables */
#define	CONST_DUAL_HASH_MODE	(12)	/* Construct dual hash */
#define	USBCAM_SERVER_DUAL_HASH_MODE	(13)
// 射影変換の補正をするかしないか
